...
const checkArchitecture = (filename) => {
  ...
  if (filename.includes('x64') || filename.includes('.exe') || filename.includes('full.nupkg')) return 'x64'; // electron forge names the exe file ...Setup.exe and the nupkg file ...full.nupkg
